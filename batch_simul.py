...
# # --- Seeding options ---
# SEED_BASE = 45965  # int -> per-run seed = SEED_BASE + run_idx
# SEEDS = None        # Optional: list of length N_RUNS to explicitly set each run's seed
# # Set SEEDS to a list (e.g., [101, 202, 303]) to override SEED_BASE.
# # Set SEED_BASE = None and SEEDS = None to fall back to run_idx (0,1,2,...) as seeds.
...
#     # default: use run index so runs are deterministic but distinct
#     return int(run_idx)
...
#     # Always set global RNGs for reproducibility, regardless of run_simulation's signature
#     random.seed(seed_val)
#     np.random.seed(seed_val)

#     # Also pass the seed to run_simulation if it accepts it
#     result = call_run_simulation(DAYS, seed_val, want_zone=True)

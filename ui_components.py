...
"""
menu.py - UI components and interaction handlers

Part of the Human Society Simulation project.

Provides slider widgets, button handling, and UI interaction logic
for the interactive simulation interface.
"""

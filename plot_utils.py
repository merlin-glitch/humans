"""
single_plot.py - Simple plotting utilities for single simulation runs

Part of the Human Society Simulation project.

Provides basic visualization functions for individual simulation runs,
including map generation and simple plot creation.
"""
